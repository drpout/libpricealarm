...
public class PriceHitLowerBoundAlarm extends PriceHitAlarm {
	...
	public PriceHitLowerBoundAlarm(long id, Exchange exchange, Pair pair, Timer timer, long period,
			Notify notify, double lowerBound) throws UpperBoundSmallerThanLowerBoundException {
		super(id, exchange, pair, timer, period, notify, Double.POSITIVE_INFINITY, lowerBound);
	}
